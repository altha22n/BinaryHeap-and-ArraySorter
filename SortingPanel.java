...
public class SortingPanel extends JPanel {
	private static String[] sortingAlgs = { "Heap", "Selection", "Insertion",
			"Bubble" };
	...
	private void randomizeArray() {
		...
		intArray = randomIntegerArray(getHeight() / 50, barDisplay.getHeight(),
				barDisplay.getWidth() / 20);
	...
	private void sort() {
		if (intArray != null) {
			...
			System.out.println("selectedSortingAlxg: " + selectedSortingAlg);
